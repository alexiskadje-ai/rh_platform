...
const LINKS: Record<Role, { href: string; label: string; icon: LucideIcon }[]> = {
  ...
  RECRUITER: [
    ...
    { href: "/company/facturation", label: "Facturation", icon: Wallet },
    { href: "/company/utilisateurs", label: "Utilisateurs internes", icon: Users },
    { href: "/settings/security", label: "Sécurité / 2FA", icon: Shield },
  ],
  CANDIDATE: [
    ...
    { href: "/candidate/booster", label: "Booster CV", icon: Sparkles },
